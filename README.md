...
|[3 - Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/description/)|python|[LC3](medium/LC3/longestsubstr.py)|Sliding Window|Hash map to store the "last seen" index of current elem.<br>Slide leftpointer to last duplicate + 1 when current elem has already appeared in this window.|
